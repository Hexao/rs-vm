...
mod tests {
    ...
    fn test_mov() {
        ...
        let instructions = [
            ...
            MOV_LIT_REG,    0x10, 0x10, DX,            // move value 0x1000 in r4 (16 bit)
            MOV_REG_PTRREG, BX,     DX,                // move r2 in memory (0x1010) pointed by r5
        ];
        ...
        assert_eq!(cpu.get_memory_at_u16(0x1010).unwrap(), 0x0010);
    }
